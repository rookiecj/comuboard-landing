      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="rounded-2xl bg-white dark:bg-slate-900/80 p-8 border border-slate-200 dark:border-slate-800 flex flex-col shadow-sm hover:shadow-md transition-shadow dark:shadow-none group relative overflow-hidden"
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                Wide, Focus 등 4가지 레이아웃은 물론, 모든 UI를 숨겨 글에만
                온전히 몰입하는 Zen 모드를 제공합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                적은 글로 강력한 슬라이드 연출을 지원합니다. :::layer 구문으로
                배경과 다용도 오버레이를 자유롭게 추가하세요.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                시간대(오전/야간)와 입력 중인 글의 문맥을 분석하여 상황에 가장
                알맞은 다의어 이모지를 자동 추천합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                아이디어 스케치를 위한 Excalidraw와 데이터베이스 스키마를 위한
                ERD 다이어그램을 기본으로 지원합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                새 글 작성, 멘션 발생 등의 커뮤니티 이벤트 발생 시 메일,
                디스코드 등으로 알림을 자동 발송합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed relative z-10">
                관리자 제어 내역이 영구적인 감사 로그(Audit Log)로 남으며,
                정교한 회원 액세스 및 아카이브 제어를 지원합니다.
              </p>
            </motion.div>
          </motion.div>
        </div>
