      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 text-center z-10 w-full">
        ...
        >
          ...
          <span className="relative z-10">
            ComuBoard 런칭! <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-400 dark:to-pink-400 font-extrabold mx-1">Pro 플랜 50% 할인</span> 🎉
          </span>
        </motion.div>
        ...
        >
          ...
          <img src="/logo.png" alt="ComuBoard Logo" className="h-16 w-16 sm:h-20 sm:w-20 drop-shadow-xl" />
          
          <span className="leading-tight">
            우리의 <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 inline-block">이야기</span>가 <br className="hidden sm:block" /> 
            쌓이는 곳
          </span>
        </motion.h1>
        ...
        >
          링크 하나, 멘션 하나로 시작하세요.<br className="hidden sm:block" />
